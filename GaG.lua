...
local Window = Rayfield:CreateWindow({
    Name = "Grow a Garden | super skidders",
    Icon = 0,
    LoadingTitle = "Grow a Garden | Booting modules",
    LoadingSubtitle = "by lsown",
    Theme = "AmberGlow",
    ...
    KeySettings = {
        ...
        Key = {
            ...
            "PermKey728199487473", "PermKey010284746371", "PermKey101082736282", "sown281", "I Am Gay"
        }
    }
})
...
print("check console lam gi vay")
print("xuan beo sun beo")
